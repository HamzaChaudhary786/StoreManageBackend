...
export declare const bulkImportProducts: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const switchCategory: (req: Request, res: Response, next: import("express").NextFunction) => void;
